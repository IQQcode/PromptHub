...
- [x] 任务 1：创建功能分析报告文档 `prompt-go/docs/functional-analysis.md`
...
- [x] 任务 2：创建交互设计文档 `prompt-go/docs/interaction-design.md`
...
- [x] 任务 3：创建 API 接口文档 `prompt-go/docs/api-specification.md`
...
- [x] 任务 4：创建前端首页模板 `prompt-go/web/index.html` 及基础样式
